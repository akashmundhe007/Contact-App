...
public class IncomingAdapter extends RecyclerView.Adapter<IncomingAdapter.ItemViewHolder> {

    private Context mContext;
    private ArrayList<IncomingCalls> arrayList;

    public IncomingAdapter(Context context, ArrayList<IncomingCalls> incomingCallsArrayList) {
        this.mContext = context;
        this.arrayList = incomingCallsArrayList;
    }
