...
public class MissedAdapter extends RecyclerView.Adapter<MissedAdapter.ItemViewHolder> {

    private Context mContext;
    private ArrayList<MissedCalls> arrayList;

    public MissedAdapter(Context context, ArrayList<MissedCalls> missedCallsArrayList) {
        this.mContext = context;
        this.arrayList = missedCallsArrayList;
    }
